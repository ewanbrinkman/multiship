...
ENTRY_SIZE = 35
# absolute distances
NEXT_GAME_BOTTOM_HEIGHT_DISTANCE = 50
OVERLAY_WIDTH_DISTANCE = 20
OVERLAY_HEIGHT_DISTANCE = 20
USERNAME_HEIGHT = -15
# percentage distances
CONNECT_QUIT_BUTTON_HEIGHT = 0.75
SHIP_SELECTION_BUTTON_HEIGHT = 0.6
MAIN_MENU_TEXT_HEIGHT = 0.475
SCORE_TITLE_HEIGHT_DISTANCE = 0.33
ENTRY_ADD_ON_HEIGHT = 0.04
ENTRY_START_HEIGHT = 0.1
TITLE_TEXT_HEIGHT = 0.075
# debug
PLAYER_COLOR = CYAN
OBSTACLE_COLOR = RED
SHALLOWS_COLOR = PINK
...
PLAYER_SHALLOW_FRICTION = -1.5
# rotation movement
PLAYER_ROT_ACC = 200
PLAYER_WATER_ROT_FRICTION = -2.5
PLAYER_SHALLOW_ROT_FRICTION = -7.5
# images
